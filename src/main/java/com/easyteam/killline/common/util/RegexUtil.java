package com.easyteam.killline.common.util;
...
public class RegexUtil {
	...
	private static final String REGEX_LOGIN = "[A-Z|a-z|0-9|_|-]*";
	 ...
	 * 
	 * @param login
	 * @return true for correct login
	 */
	public static boolean validLogin(String login) {
		if (login != null && !login.trim().isEmpty()) {
			return login.trim().matches(REGEX_LOGIN);
		}
		return false;
	}
